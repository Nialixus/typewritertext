...
// //         for (int x = 0; x < (widget.text.data?.characters.length ?? 0); x++)
...
// class TypeWriterText extends StatefulWidget {
//   const TypeWriterText({Key? key, required this.text, this.controller}) : super(key: key);
...
// class _TypeWriterTextState extends State<TypeWriterText> {
//   late TypeWriterTextController controller =
//       widget.controller ?? TypeWriterTextController(widget.text.data ?? widget.text.textSpan?.toPlainText() ?? "");
//   @override
//   Widget build(BuildContext context) {
//     return ValueListenableBuilder(
//         valueListenable: controller,
//         builder: ((context, value, child) {
//           if (widget.text.data != null) {
//             return Text(
//               widget.text.data!,
//             );
//           } else {
//             final textspan = widget.text.textSpan! as TextSpan;
//             return Text.rich(
//               textspan,
//               key: widget.text.key,
//               locale: widget.text.locale,
...
// class TypeWriterTextController extends ValueNotifier<String> {
//   TypeWriterTextController(String value) : super(value);
// }
